...
uniqx() {
  # https://www.reddit.com/r/commandline/comments/3f0mhl/comment/ctkgs96/
...
alias la="exa -la"
alias vim="nvim"
alias sr="history | sort -r | cut -c 8- | uniqx | fzf | xargs echo -n | xclip -selection clipboard"  # [S]earch [R]ecent commands
alias sf='fd --type f -H --exclude .git | fzf | xargs echo -n | xclip -selection clipboard'          # [S]earch [F]iles
alias sfi='fd --type f -H -d 1 | fzf | xargs echo -n | xclip -selection clipboard'                   # [S]earch [F]iles [I]n current directory
